...
- (void)viewDidLoad
{
    ...
    for (int i = 0; i < imageNameArray.count; i++)
    {
        ...
        {
            UIButton *enterButton = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/4, SCREEN_HEIGHT-70, SCREEN_WIDTH/2, 50)];
            [enterButton setBackgroundImage:[UIImage imageNamed:@"commom_start_now.jpg"] forState:UIControlStateNormal];
